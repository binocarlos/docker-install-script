...
curl -k --progress-bar -L https://github.com/resin-io/linux-raspberrypi-aufs_friendly-PKGBUILD/releases/download/v3.10.19-1-ARCH/$PACKAGE > $TMP_DIR/$PACKAGE
...
echo "Downloading $PACKAGE"
curl -k --progress-bar -L https://github.com/resin-io/aufs3-util-PKGBUILD/releases/download/v20130907-1/$PACKAGE > $TMP_DIR/$PACKAGE

PACKAGE=docker-0.8.0-1-armv6h.pkg.tar.xz
echo "Downloading $PACKAGE"
curl -k --progress-bar -L https://github.com/resin-io/lxc-docker-PKGBUILD/releases/download/v0.8.0-1/$PACKAGE > $TMP_DIR/$PACKAGE
